...
test('Should validate ZEC bech32', t => {
  ...
  const validatedMain = cryptoValidator.bech32Validator('main', mainNetaddr, ZECBech32Opts)
  const validatedTest = cryptoValidator.bech32Validator('test', testNetaddr, ZECBech32Opts)
  t.true(validatedMain)
  t.true(validatedTest)
})
